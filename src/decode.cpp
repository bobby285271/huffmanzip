...
void destTree::read_compressed_file(const char *origin_file)
{
    std::ios::sync_with_stdio(false);
    std::ifstream infile_stream(origin_file,
...
void destTree::get_decode_result(const char *dest_file)
{
    std::ofstream outfile_stream(dest_file,
